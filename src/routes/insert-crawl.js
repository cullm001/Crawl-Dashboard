...
module.exports = (pool) => {
  ...
  router.post('/insert-crawl', (req, res) => {
    ...
    const customer_query = "INSERT INTO customer_data (api_key, customer_name, contact_email, created_at) VALUES (?, ?, ?, ?)";
    ...
    pool.query(customer_query, [
      ...
      pool.query(crawl_query, [
        ...
        const node_query = "INSERT INTO node_data (node_id, node_name, created_at) VALUES (?, ?, ?)";
        ...
        pool.query(node_query, [
          ...
          const node_metrics_query = "INSERT INTO node_metrics_data (id, node_id, metric_time, cpu_usage, memory_usage, bandwidth_usage, disk_space_usage) VALUES (?, ?, ?, ?, ?, ?, ?)";
